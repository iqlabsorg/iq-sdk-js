...
interface BorrowTokenStorageInterface extends ethers.utils.Interface {
  functions: {
...
export class BorrowTokenStorage extends BaseContract {
  ...
  interface: BorrowTokenStorageInterface;
