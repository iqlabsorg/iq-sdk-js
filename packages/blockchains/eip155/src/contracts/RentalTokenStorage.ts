...
export interface RentalTokenStorageInterface extends utils.Interface {
  functions: {
...
export interface RentalTokenStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RentalTokenStorageInterface;
