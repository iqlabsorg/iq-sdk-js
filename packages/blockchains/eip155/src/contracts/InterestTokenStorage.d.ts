...
interface InterestTokenStorageInterface extends ethers.utils.Interface {
  functions: {
...
export class InterestTokenStorage extends BaseContract {
  ...
  interface: InterestTokenStorageInterface;
