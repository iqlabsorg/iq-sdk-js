...
interface ERC1155MockReceiverInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC1155MockReceiver extends Contract {
  ...
  interface: ERC1155MockReceiverInterface;
