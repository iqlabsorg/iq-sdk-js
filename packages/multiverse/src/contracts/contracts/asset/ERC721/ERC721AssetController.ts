...
export interface ERC721AssetControllerInterface extends utils.Interface {
  functions: {
...
export interface ERC721AssetController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721AssetControllerInterface;
