...
export interface ERC721WarperControllerInterface extends utils.Interface {
  functions: {
...
export interface ERC721WarperController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721WarperControllerInterface;
