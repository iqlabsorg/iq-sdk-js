...
interface FixedPriceListingControllerInterface extends ethers.utils.Interface {
  functions: {
...
export class FixedPriceListingController extends BaseContract {
  ...
  functions: {
    calculateRentalFee(
      strategyParams: { strategy: BytesLike; data: BytesLike },
      rentingParams: {
        listingId: BigNumberish;
        warper: string;
        renter: string;
