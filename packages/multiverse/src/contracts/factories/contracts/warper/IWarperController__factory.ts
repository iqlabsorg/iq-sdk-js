...
import type {
  IWarperController,
  IWarperControllerInterface,
} from "../../../contracts/warper/IWarperController";
...
export class IWarperController__factory {
  static readonly abi = _abi;
  static createInterface(): IWarperControllerInterface {
    return new utils.Interface(_abi) as IWarperControllerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IWarperController {
    return new Contract(address, _abi, signerOrProvider) as IWarperController;
  }
}
