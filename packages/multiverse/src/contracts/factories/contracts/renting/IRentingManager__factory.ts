...
import type {
  IRentingManager,
  IRentingManagerInterface,
} from "../../../contracts/renting/IRentingManager";
...
export class IRentingManager__factory {
  static readonly abi = _abi;
  static createInterface(): IRentingManagerInterface {
    return new utils.Interface(_abi) as IRentingManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IRentingManager {
    return new Contract(address, _abi, signerOrProvider) as IRentingManager;
  }
}
