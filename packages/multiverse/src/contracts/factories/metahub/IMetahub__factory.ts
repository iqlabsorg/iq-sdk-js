...
import type { IMetahub, IMetahubInterface } from "../../metahub/IMetahub";
...
export class IMetahub__factory {
  static readonly abi = _abi;
  static createInterface(): IMetahubInterface {
    return new utils.Interface(_abi) as IMetahubInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IMetahub {
    return new Contract(address, _abi, signerOrProvider) as IMetahub;
  }
}
