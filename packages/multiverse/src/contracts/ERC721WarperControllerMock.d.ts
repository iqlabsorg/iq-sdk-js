...
interface ERC721WarperControllerMockInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721WarperControllerMock extends BaseContract {
  ...
  functions: {
    ...
    calculatePremiums(
      arg0: { id: { class: BytesLike; data: BytesLike }; value: BigNumberish },
      arg1: {
        listingId: BigNumberish;
        warper: string;
        renter: string;
