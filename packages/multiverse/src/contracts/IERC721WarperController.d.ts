...
interface IERC721WarperControllerInterface extends ethers.utils.Interface {
  functions: {
...
export class IERC721WarperController extends BaseContract {
  ...
  interface: IERC721WarperControllerInterface;
