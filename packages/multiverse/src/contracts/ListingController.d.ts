...
interface ListingControllerInterface extends ethers.utils.Interface {
  functions: {
...
export class ListingController extends BaseContract {
  ...
  interface: ListingControllerInterface;
